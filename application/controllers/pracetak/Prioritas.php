...
class PrioritasPracetak extends CI_Controller {

	public function __construct()
    {	
        parent::__construct();
		check_not_login();
        $this->load->model('PrioritasPracetak_m', 'pp');
    }
	...
	public function index()
	{
		...
		$query = $this->pp->get();
		$data = array(
			'judul' => 'Prioritas Pracetak',
			'pp' => $query->result(),
		);		
		$this->template->load('pracetak/template','pracetak/prioritas/prioritas',$data);
	}
