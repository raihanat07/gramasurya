...
class Imposisi_m extends CI_Model {
    ...
    {
        $this->db->select(
            'imposisi.status_imposisi_khusus as status_khusus, imposisi.status_imposisi_cover as status_cover, imposisi.status_imposisi_isi as status_isi,
    ...
    public function tambah_imposisi($data)
	{
            $tambah_imposisi = array(
                ...
                'status_imposisi_khusus' =>$data['status_imposisi_khusus'],
                'status_imposisi_cover' =>$data['status_imposisi_cover'],
                'status_imposisi_isi' =>$data['status_imposisi_isi'],
