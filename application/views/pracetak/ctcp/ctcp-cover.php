    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        ...
        <label>PROSES HITUNG EDD</label>
          <form action="<?= site_url('pracetak/ctcp/filter_haricover') ?>" method="post">
            <div class="row">
              <div class="col-md-3">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <table id="table1" class="table table-bordered table-hover" style="font-size: 12px">
        <thead>
        <tr align="center">
          <td>Tanggal Ctcp 1</td>
          <td>Tanggal Ctcp 2</td>
          <td>Tanggal Ctcp 3</td>
          <td>Nomor SO</td>
          <td>Tanggal Masuk</td>
          <td>Deadline</td>
          <td>Nama Pemesan</td>
        ...
        <td align="center">
            <?php
              if($row->cover1tglctcp1 !=null){
                echo $row->cover1tglctcp1;
              }
              else
                echo "-";
            ?>
          ...
          <td align="center">
            <?php
              if($row->cover1tglctcp2 !=null){
                echo $row->cover1tglctcp2;
              }
              else
                echo "-";
            ?>
          ...
          <td align="center">
            <?php
              if($row->cover1tglctcp3 !=null){
                echo $row->cover1tglctcp3;
              }
              else
                echo "-";
            ?>
