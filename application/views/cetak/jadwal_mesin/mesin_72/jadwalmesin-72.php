              ...
              <?php if ($this->fungsi->user_login()->level == 2 || $this->fungsi->user_login()->level == 6) { ?>
                <td align="center">
                  ...
                  <a href="<?= site_url('cetak/Jadwalmesin/edit_72/' . $row->id_mesin_72) ?>">
                    <i class="fa fa-pencil" style="font-size:18px;margin-right: 18px;"></i>
                  </a>
                  <a href="<?= site_url('cetak/Jadwalmesin/del72/' . $row->id_mesin_72) ?>" onclick="return confirm('Apakah Anda Yakin')">
                    <i class="fa fa-trash" style="font-size:18px;margin-right: 18px;"></i>
                  </a>
                  <?php if ($cek_id_mesin[$nilai] != null) { ?>
                    <a href="<?= site_url('cetak/Jadwalmesin/print_72/' . $row->id_mesin_72 . "-" . $row->id_order) ?>">
                      <i class="fa fa-print" style="font-size:18px;margin-right: 18px;"></i>
                    </a>
                  <?php } ?>
                  <?php if ($cek_id_mesin[$nilai] == null) { ?>
