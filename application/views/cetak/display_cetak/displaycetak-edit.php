        ...
        <input type="text" name="id_order"  value="<?= $row->id_order; ?>" hidden>            
                ...
                <div class="row">
                    ...
                    <input type="text" name="status_cetak_cover" value="" hidden>
                        <input class="form-check-input" type="checkbox" name="status_cetak_cover" value="Cetak Cover" <?php echo $row->status_cetak_cover !=null ?  "checked" : "" ?>>
                        <label class="form-check-label" for="flexCheckDefault">Cetak Cover</label>
                    </div>
                    <div class="col-md-2">
                    <input type="text" name="status_cetak_isi" value="" hidden>
                        <input class="form-check-input" type="checkbox" name="status_cetak_isi" value="Cetak Isi"  <?php echo $row->status_cetak_isi !=null ?  "checked" : "" ?>>
                        <label class="form-check-label" for="flexCheckDefault">Cetak Isi</label>
                    </div>
                    <div class="col-md-2">
                    <input type="text" name="status_cetak" value="" hidden>
                        <input class="form-check-input" type="checkbox" name="status_cetak" value="Cetak"  <?php echo $row->status_cetak !=null ?  "checked" : "" ?>>
