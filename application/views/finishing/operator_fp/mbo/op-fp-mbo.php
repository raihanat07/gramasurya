...
<section class="content">
  ...
  <div class="row" style="padding: 10px;">
    <div class="col" style="background: #FFEEE3;">
      ...
      <div class="row" style="padding: 10px;">
        <div class="col">
          <a href="<?=site_url()?>finishing/OperatorFP/edit_op_mbo" class="btn btn-success" style="min-height: 50px;width: 100%;padding-top: 12px;">
  ...
  <div class="row" style="padding: 10px;">
    <div class="col" style="background: #FFEEE3;">
      ...
      <div class="row" style="padding: 10px;">
        <div class="col">
          <a href="<?=site_url()?>finishing/OperatorFP/edit_op_tambah_mbo" class="btn btn-success" style="min-height: 50px;width: 100%;padding-top: 12px;">
            <i class="fa fa-pencil" style="font-size:14px;margin-right:5px"></i>
            <b>Lapor Pengerjaan</b>
          </a>
        </div>
