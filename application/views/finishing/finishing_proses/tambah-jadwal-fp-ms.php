      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              <div class="col">TOTAL :</div>
              <div class="col"> (disesuaikan)<!-- <input type="number" class="form-control" name="totallembarlipat2"> --></div>
              <div class="col">Lembar</div>
            </div>
          </div>
        </div><br>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              <div class="col">TOTAL :</div>
              <div class="col"> (disesuaikan)<!-- <input type="number" class="form-control" name="totallembarlipat3"> --></div>
              <div class="col">Lembar</div>
            </div>
          </div>
        </div><br>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              <div class="col">TOTAL :</div>
              <div class="col"> (disesuaikan)<!-- <input type="number" class="form-control" name="totallembarlipat4"> --></div>
              <div class="col">Lembar</div>
            </div>
          </div>
        </div><br>
