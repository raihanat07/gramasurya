      ...
      <!-- Default box -->
            <div class="card">
                ...
                <table id="example2" class="table table-bordered table-striped" style="font-size: 12px">
                    ...
                    <?php if($row->status_shoe ==""){ ?>                    
                    <tr>
                        <td><?= $row->tanggal_pelaksanaan_shoe; ?></td>
                        <td><?= $row->nomor_so; ?></td>
                        ...
                        <td><?php echo $row->status_shoe == "shoe" ?  "finishing proses isi" : $row->so_status?></td>   

                        <td align="center">                          
                          <a href="<?=site_url()?>finishing/FinishingProses/edit_jadwal_fp_shoe/<?= $row->id_order; ?>">
                            <i class="fa fa-pencil" style="font-size:18px;margin-right: 20px;"></i>
                          </a>
                          <a href="<?=site_url()?>finishing/FinishingProses/lihat_jadwal_fp_shoe/<?= $row->id_order; ?>">
                            <i class="fa fa-eye" style="font-size:18px;"></i>
                          </a>
                        </td>
                      </tr>
                    <?php } else if($row->status_shoe =="shoe" and $row->id_jadwal_shoe == 0){?>
                      <tr>
                        <td><?= $row->tanggal_pelaksanaan_shoe; ?></td>
                        <td><?= $row->nomor_so; ?></td>
                        <td><?= $row->tanggal_masuk; ?></td>
