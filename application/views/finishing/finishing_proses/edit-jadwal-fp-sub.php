    ...
    <div class="card-body">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <input type="date" class="form-control" name="tanggal_kembali1_sub" placeholder="Tanggal Kembali Sub">
          </div>
          <div class="col-md-2">
            <input type="number" class="form-control" name="hasil1" placeholder="Hasil">
          </div>
          <div class="col-md-2">
            <input type="number" class="form-control" name="rejek1" placeholder="Rejek">
          </div>
          <div class="col-md-4">
            <input type="text" class="form-control" name="keterangan1" placeholder="Keterangan">
          </div>
        </div><br>
        <div class="row">
          <div class="col-md-1" align="center"><label>2</label></div>
          <div class="col-md-3">
            <input type="date" class="form-control" name="tanggal_kembali2_sub" placeholder="Tanggal Kembali Sub">
          </div>
          <div class="col-md-2">
            <input type="number" class="form-control" name="hasil2" placeholder="Hasil">
          </div>
          <div class="col-md-2">
            <input type="number" class="form-control" name="rejek2" placeholder="Rejek">
          </div>
          <div class="col-md-4">
            <input type="text" class="form-control" name="keterangan2" placeholder="Keterangan">
          </div>
        </div><hr><br>
