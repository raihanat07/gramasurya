    ...
    <div class="card-body">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-2">Jenis Lipatan</div>
          <div class="col-md-2">Hasil Lipatan</div>
          <div class="col-md-2">Nama Operator</div>
          <div class="col-md-2">Tanggal Pengerjaan</div>
          <div class="col-md-2">Keterangan</div>
        </div><br>
        <div class="row">
          <div class="col-md-2">Lembar 1</div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
        ...
        <div class="row">
          <div class="col-md-2">Lembar 2</div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
        ...
        <div class="row">
          <div class="col-md-2">Lembar 3</div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
        ...
        <div class="row">
          <div class="col-md-2">Lembar 4</div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
        ...
        <div class="row">
          <div class="col-md-2">Lembar 5</div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
        ...
        <div class="row">
          <div class="col-md-2">Lembar 6</div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
        ...
        <div class="row">
          <div class="col-md-2">Lembar 7</div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
        ...
        <div class="row">
          <div class="col-md-2">Lembar 8</div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
        ...
        <div class="row">
          <div class="col-md-2">Lembar 9</div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
        ...
        <div class="row">
          <div class="col-md-2">Lembar 10</div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
          <div class="col-md-2"><label class="form-label">dari db</label></div>
