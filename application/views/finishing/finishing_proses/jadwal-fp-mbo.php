            ...
            <div class="card">
                ...
                <table id="example2" class="table table-bordered table-striped" style="font-size: 12px">
                    ...
                    <tbody>
                        ...
                        <td>Total / Hari</td>
                        <td align="center">
                          <a href="<?=site_url()?>finishing/FinishingProses/tambah_jadwal_fp_mbo">
                            <i class="fa fa-plus" style="font-size:18px;margin-right: 20px;"></i>
                          </a>
                          <a href="<?=site_url()?>finishing/FinishingProses/edit_jadwal_fp_mbo">
                            <i class="fa fa-pencil" style="font-size:18px;margin-right: 20px;"></i>
                          </a>
                          <a href="<?=site_url()?>finishing/FinishingProses/lihat_jadwal_fp_mbo">
