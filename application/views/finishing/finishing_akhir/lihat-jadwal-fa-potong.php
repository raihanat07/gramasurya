    ...
    <div class="card-body">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            Keterangan<br>
            <textarea name="keterangan_finishing_akhir_potong" class="form-control" placeholder="catatan" style="height: 150px;" disabled></textarea>
          </div>
          <div class="col-md-2">  
            Hasil Binding<br>
            <label>dari db</label>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <input type="text" class="form-control" name="keterangan1_mesin_potong" placeholder="Keterangan" disabled>
          </div>
        </div><br>
        <div class="row">
          ...
          <div class="col-md-3">
            <input type="text" class="form-control" name="keterangan2_mesin_potong" placeholder="Keterangan" disabled>
          </div>
        </div><br>
        <div class="row">
          ...
          <div class="col-md-3">
            <input type="text" class="form-control" name="keterangan#_mesin_potong" placeholder="Keterangan" disabled>
          </div>
        </div><br>
        <div class="row">
          ...
          <div class="col-md-3">
            <input type="text" class="form-control" name="keterangan4_mesin_potong" placeholder="Keterangan" disabled>
          </div>
        </div>
        <div class="row">
          <div class="col">
