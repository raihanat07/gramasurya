          ...
          <table id="example2" class="table table-bordered table-striped" style="font-size: 12px">
            ...
            <tbody>
              <tr>
                ...
                <td>Total</td>
                <td align="center">
                  <a href="<?=site_url()?>finishing/FinishingAkhir/tambah_jadwal_fa_spiral">
                    <i class="fa fa-plus" style="font-size:18px;margin-right: 20px;"></i>
                  </a>
                  <a href="<?=site_url()?>finishing/FinishingAkhir/edit_jadwal_fa_spiral">
                    <i class="fa fa-pencil" style="font-size:18px;margin-right: 20px;"></i>
                  </a>
                  <a href="<?=site_url()?>finishing/FinishingAkhir/lihat_jadwal_fa_spiral">
